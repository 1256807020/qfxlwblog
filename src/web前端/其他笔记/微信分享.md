...
2. 将微信js接口安全域名的文件放在`public`文件夹下面
   ...
   ![image-20200502134401364](https://www.qfxlw.com/images/微信分享01.png)
...
function getWXSignature (url, params) {
  ...
  xhr.open('get', 您的host地址 + '/getSignature?url=https://www.qfxlw.com', true)
  xhr.send()
  xhr.onload = function(){
...
function shareContent (params) {
  ...
  var desc = '前端学习圈'
  var imgUrl = 'https://www.qfxlw.com/weblearns.png'
